            ...
            <?php foreach ($data['komli'] as $komli): ?> 
              <tr >
                ...
                <td style="text-align:center;">
                  <a href="<?= BASE_URL; ?>/komli/detail/<?= $komli['id']; ?>"class="btn btn-primary"
                    style="border-radius:10px;font-size:13px;padding: 2px 15px;">Detail</a>
                  <a href="<?= BASE_URL; ?>/komli/hapus/<?= $komli['id']; ?>"onclick="return confirm('Hapus data')"class="btn btn-danger"
                    style="margin-top:5px;border-radius:10px;font-size:13px;padding: 2px 15px;">Hapus</a>
                  <a  href="<?= BASE_URL; ?>/komli/getubah/<?= $komli['id']; ?>"class="btn btn-success"
